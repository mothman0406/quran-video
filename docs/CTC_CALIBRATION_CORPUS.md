...
| `tools/timing-benchmark/.cache/audio/Alafasy_128kbps/*.mp3` | 19 files; 89.07 s total; 1.85–7.11 s each | 93:1–11 and 94:1–8 from filenames/cache manifest | Repeated 93:1 and mixed case |
...
The strongest-window positions are respectively 0, 1, 1, 7, 1, and 0. Full
...
The table orders known positives as 2:258–259, 6:74–77, and 74:1–9; the
...
| --- | --- | --- | --- | --- |
| Arithmetic mean | `-.844800, -1.177863, -1.377429` | `-.837851` | `-.994230, -.685191, -1.668964, -.494320, -1.749620` | No |
| Voiced-duration mean | `-.844800, -1.177863, -1.439770` | `-.837851` | `-.995862, -.685191, -1.617766, -.493271, -1.751439` | No |
| Target-coverage mean | `-.844800, -1.177863, -1.040097` | `-.837851` | `-.733426, -.685191, -1.463054, -.464645, -1.741566` | No |
| Median | `-.646189, -.726755, -.938646` | `-.640654` | `-.689900, -.685191, -2.006666, -.647827, -1.724815` | No |
| 10% trimmed mean | `-.811121, -1.077308, -1.377429` | `-.837851` | `-.994230, -.685191, -1.668964, -.494320, -1.749620` | No |
| 10% winsorized mean | `-.830422, -1.130956, -1.377429` | `-.837851` | `-.994230, -.685191, -1.668964, -.494320, -1.749620` | No |
| 75th percentile | `-.434903, -.495891, -.632733` | `-.591399` | `-.417566, -.685191, -.735243, -.396530, -1.687063` | Yes, only `0.052458` |
| Strongest-three mean | `-.199509, -.338614, -1.377429` | `-.607152` | `-.994230, -.685191, -.602608, -.494320, -1.674182` | No |
| Anchor-aware mean | `-.668121, -.959340, -1.377429` | `-.679730` | `-1.095673, -.685191, -1.084026, -.429127, -1.749620` | No |
| Post-anchor mean | `-.592401, -.813659, -1.377429` | `-.574316` | `-1.146395, -.685191, -.401598, -.396530, -1.749620` | No |
| Best plus support | `-.446685, -.557528, -.660153` | `-.915149` | `-.478566, -1.185191, -.694483, -.478566, -2.148422` | No |
| Strongest-half mean | `-.392379, -.473052, -.632733` | `-.574316` | `-.417566, -.685191, -.953623, -.396530, -1.686841` | Yes, only `0.052458` |
...
Production should **not** change. The only separation is narrow and
gate-conditioned, and the real strong-repetition case is an overall Whisper
fallback false positive. The next evidence needed is an independent-reader,
long positive recording (five or more generated windows) captured in this
format—preferably a different reciter—with boundary-quality CTC outliers like
2:258–259 and 6:74–77. That establishes whether upper-quartile/strongest-half
separation is stable across readers and length before any long-path gate change.

...
async function main() {
  ...
  await execFileAsync(process.execPath, ["--experimental-strip-types", "--test", "tests/fastconformer-identification.test.ts", "tests/passage-decision.test.ts", "tests/passage-identification-debug.test.ts", "tests/passage-id-metrics.test.ts"], { cwd: process.cwd() });

...
export function tiktokStatusMessage(status: TikTokPublishStatus, mode: "direct" | "draft"): string {
  if (status.status === "PUBLISH_COMPLETE") return mode === "direct" ? "Posted to TikTok" : "Published from TikTok";

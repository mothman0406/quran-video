...
export default function PrivacyPage() {
  return <main className="legal-page">
    ...
    <p>We use Supabase for authentication and saved cloud projects. Google OAuth is used only when you choose Google sign-in. Your account email and basic provider profile information are used to identify your account.</p>
    ...
    <p>You can delete saved cloud projects from Projects. Account Settings lets you delete your account, saved project metadata, private project media, and application billing mappings. Active subscriptions are cancelled before account removal; Stripe may retain records it is required to keep.</p>

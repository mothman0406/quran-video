...
export default function EditorWorkspace(props: EditorWorkspaceProps) {
  ...
  const {
    ...
    exportOpen, exportPreflight, exportQuality, outputPlan, exportResult, exportState, exportError, exportDiagnostics, errorMessage, timingWarning,
